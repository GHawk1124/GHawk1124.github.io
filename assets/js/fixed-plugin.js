...
function sidebarColor(a) {
    ...
    var checkedSidenavCardColorFrom = "after:from-" + (color_from == "blue-700" ? "slate-600" : color_from);
    var checkedSidenavCardColorTo = "after:to-" + (color_to == "white-500" ? "slate-300" : color_to);

    var checkedSidenavCardIconColorClassFrom = "from-" + (color_from == "blue-700" ? "slate-600" : color_from);
    var checkedSidenavCardIconColorClassTo = "to-" + (color_to == "white-500" ? "slate-300" : color_to);
    ...
    for (var i = 0; i < parent.length; i++) {
        if (parent[i].hasAttribute("active-color")) {
            ...
            activeSidenavCardIconColorClassFrom = "from-" + (activeColorFrom == "blue-700" ? "slate-600" : activeColorFrom);
            activeSidenavCardIconColorClassTo = "to-" + (activeColorTo == "white-500" ? "slate-300" : activeColorTo);
        }
